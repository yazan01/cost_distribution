...
def get_columns(filters):
    ...
    if filters.get("company") == "iValue KSA":
        columns = [
            ...
            {"label": _("Housing"), "fieldname": "housing", "fieldtype": "Currency", "width": 120},
            {"label": _("Nationality"), "fieldname": "nationality", "fieldtype": "Data", "width": 100},
            {"label": _("GOSI amount for the company"), "fieldname": "gosi", "fieldtype": "Currency", "width": 150},
            {"label": _("Increment"), "fieldname": "increment", "fieldtype": "Currency", "width": 120},
            {"label": _("Promotion"), "fieldname": "promotion", "fieldtype": "Currency", "width": 120},
            {"label": _("Medical Insurance / Month"), "fieldname": "medical_insurance", "fieldtype": "Currency", "width": 150},
            {"label": _("No of Family"), "fieldname": "no_of_family", "fieldtype": "Int", "width": 100},
            {"label": _("Ticket"), "fieldname": "ticket", "fieldtype": "Currency", "width": 120},
            {"label": _("Iqama Cost / Month"), "fieldname": "iqama_cost", "fieldtype": "Currency", "width": 150},
            {"label": _("VISA"), "fieldname": "visa", "fieldtype": "Currency", "width": 120},
            {"label": _("Training cost / month"), "fieldname": "training_cost", "fieldtype": "Currency", "width": 150},
            {"label": _("Penalty"), "fieldname": "penalty", "fieldtype": "Currency", "width": 120},
            {"label": _("EOS"), "fieldname": "eos", "fieldtype": "Currency", "width": 120},
            {"label": _("Yearly Bonus / Month"), "fieldname": "yearly_bonus", "fieldtype": "Currency", "width": 150},
            {"label": _("WHT"), "fieldname": "wht", "fieldtype": "Currency", "width": 120},
        ...
        columns = [
            ...
            {"label": _("Social Security amount for the company"), "fieldname": "social_security", "fieldtype": "Currency", "width": 150},
