...
def get_columns(filters):
	...
	columns = [
		...
		{"label": _("Against Account"), "fieldname": "against","hidden": 1, "width": 120},
	...
	if filters.get("include_dimensions"):
		...
		columns.append(
			{"label": _("Cost Center"), "options": "Cost Center", "fieldname": "cost_center", "hidden": 1, "width": 100}
		)

	columns.extend(
		[
			{"label": _("Against Voucher Type"), "fieldname": "against_voucher_type", "hidden": 1, "width": 100},
			{
			...
			{"label": _("Supplier Invoice No"), "fieldname": "bill_no", "fieldtype": "Data", "hidden": 1, "width": 100},
			{"label": _("Remarks"), "fieldname": "remarks", "hidden": 1, "width": 400},
		]
	)
