frappe.query_reports["Partner Portfolio Financial Performance Par Project"] = {
    "filters": [
        {
            "fieldname": "partner",
            "label": ("Partner"),
    ...
    onload: function (report) {
        frappe.call({
            ...
            callback: function (res) {
                ...
                frappe.call({
                    method: "cost_distribution.cost_distribution.report.partner_portfolio_financial_performance_par_project.partner_portfolio_financial_performance_par_project.get_partner_list",
                    callback: function (r) {
