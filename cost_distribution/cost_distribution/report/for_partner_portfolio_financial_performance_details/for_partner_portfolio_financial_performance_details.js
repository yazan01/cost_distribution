frappe.query_reports["For Partner Portfolio Financial Performance Details"] = {
    "filters": [
        {
            "fieldname": "partner",
            "label": ("Partner"),
    ...
    onload: function (report) {
        frappe.call({
            ...
            callback: function (res) {
                ...
                frappe.call({
                    method: "cost_distribution.cost_distribution.report.for_partner_portfolio_financial_performance_details.for_partner_portfolio_financial_performance_details.get_partner_list",
                    callback: function (r) {
