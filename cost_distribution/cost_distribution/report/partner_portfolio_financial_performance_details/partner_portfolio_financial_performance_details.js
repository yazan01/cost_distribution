    ...
    "filters": [
        ...
        },
        {
            ...
            "get_data": function (txt) {
                ...
                return frappe.call({
                    method: "cost_distribution.cost_distribution.report.partner_portfolio_financial_performance_details.partner_portfolio_financial_performance_details.get_projects_by_partner",
                    args: {
                        partner: partner,
                        txt: txt || "",
