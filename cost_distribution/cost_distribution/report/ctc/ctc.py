...
def execute(filters=None):
    ...
    if not selected_projects:
        ...
        accessible_projects_list_exp_1 = [project[0] for project in accessible_projects_exp]
    ...
    columns = [
        ...
        {"label": "Level CTC", "fieldname": "Level CTC", "fieldtype": "Float", "precision": 2, "width": 150},
        {"label": "Total Hours", "fieldname": "Total Hours", "fieldtype": "Float", "precision": 2, "width": 100},
        {"label": "Hours Rate", "fieldname": "Hours Rate", "fieldtype": "Float", "precision": 2, "width": 150},
        {"label": "Hours", "fieldname": "Hours", "fieldtype": "Float", "precision": 2, "width": 100},
        {"label": "Total", "fieldname": "Total", "fieldtype": "Float", "precision": 2, "width": 150},
